 ...
 */
final class Version20240731135045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (email_auth_code VARCHAR(255) DEFAULT NULL, id BINARY(16) NOT NULL, api_token VARCHAR(255) DEFAULT NULL, totp_secret VARCHAR(255) DEFAULT NULL, google_secret VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, switch_user_able TINYINT(1) NOT NULL, passport_id INT NOT NULL, git_hub_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D6494C8796 (git_hub_id), UNIQUE INDEX UNIQ_USER_EMAIL (email), UNIQUE INDEX UNIQ_USER_PASSPORT (passport_id), UNIQUE INDEX UNIQ_USER_API_TOKEN (api_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
