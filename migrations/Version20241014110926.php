 ...
 */
final class Version20241014110926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media (file_token VARCHAR(60) DEFAULT NULL, key_frames LONGTEXT DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, filepath VARCHAR(255) NOT NULL, file_original_name VARCHAR(255) NOT NULL, created_at DATETIME(6) NOT NULL, updated_at DATETIME(6) DEFAULT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
