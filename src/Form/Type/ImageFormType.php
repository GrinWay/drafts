...
class ImageFormType extends AbstractFormType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ->add('filepath', //FormType\TextType::class, 
				options: [
				],
			)
            ->add('fileOriginalName', //FormType\TextType::class, 
				options: [
				],
			)
            ->add('fileToken', //FormType\TextType::class, 
				options: [
					'block_name' => 'file_token',
				],
			)
			->add('updatedAt', //FormType\ChoiceType::class,
				options: [
